<template>
  <div class="gallery-container flex w-full justify-center">
    <img  class=" max-w-full h-screen object-cover mx-auto" src="https://wesgarde.com/wp-content/uploads/AdobeStock_283803282-1-scaled.jpeg" alt="steak">
