  ...
  <div id="app" class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8">
    <div class="z-10 bg-gray-800/50 backdrop-blur-md rounded-lg border-4 border-white shadow-2xl p-8 space-y-6 text-center">
      ...
      <div class="scroll-container">
        ...
        <img class="p-4 max-h-96 object-cover rounded-lg border-2 border-blue-500" src="https://i.ibb.co/vPQ5FN6/98520-F5-D-F05-A-4-AA8-9217-58-C40-F24-BDFE-1-201-a.jpg" alt="Futuristic Image 5">
      </div>
      <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline-blue active:bg-blue-800 transition duration-300">Embark on the Journey</button>
    </div>
  </div>
</template>
